...
<div class="container bg-white p-5 rounded shadow-sm">
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-header bg-warning text-white fw-bold d-flex justify-content-between align-items-center">
            ...
            {{-- Botón de descarga --}}
            <form action="{{ route('areas-despacho.generarReporte', ['id' => $areaDespacho->id]) }}" method="GET"
                target="_blank">
                ...
                <div class="card-body bg-light-subtle rounded p-3">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="{{ $registro->numero_foja }}" readonly>
    ...
    <div class="card mb-4 shadow-sm">
        ...
        <div class="card-body">
            ...
            <div class="mt-3">
                <a href="{{ route('areas-despacho.show', $areaDespacho->id) }}" class="btn btn-secondary">
    ...
    <a href="{{ route('areas-despacho.index') }}" class="btn btn-secondary mt-3"><i class="bi bi-arrow-left"></i>
        Volver</a>
</div>
