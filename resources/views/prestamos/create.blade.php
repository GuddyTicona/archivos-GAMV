...
<div class="container py-4">
    <div class="card shadow-lg border-0">
        <div class="card-header bg-primary text-white text-center">
            <h5 class="mb-0">Registrar Prestamo</h5>
        </div>
            ...
            <form action="{{ route('prestamos.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="solicitante" class="form-control" placeholder="" required>
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label fw-bold">Cargo</label>
                        <input type="text" name="cargo_departamento" class="form-control" placeholder="">
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea name="motivo_prestamo" class="form-control" rows="3" placeholder=""></textarea>
                    </div>
