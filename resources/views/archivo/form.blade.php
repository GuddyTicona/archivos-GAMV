                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="estado" id="estado"
                                    ...
                                    <option value="Activo" {{ old('estado', $archivo?->estado) == 'Activo' ? 'selected':'' }}>Activo</option>
                                    <option value="Inactivo" {{ old('estado', $archivo?->estado) == 'Inactivo' ? 'selected':'' }}>Inactivo</option>
                                </select>
