...
<div class="section">
    <div class="section-title">Preventivos de la Fecha {{ $fechaActa }}</div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:right; font-weight:bold;">{{ number_format($todosPreventivos->sum('total_pago'), 2, ',', '.') }}</td>
                </tr>
            </tbody>
        </table>
    @endif
