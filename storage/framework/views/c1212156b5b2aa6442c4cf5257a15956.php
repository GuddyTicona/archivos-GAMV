...
<div class="container py-4">
    ...
    <!--<div class="welcome-banner">
        ...
        <div class="roles-container">
            <?php $__currentLoopData = Auth::user()->getRoleNames(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <span class="role-badge"><?php echo e(ucfirst($role)); ?></span>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="count-number"><?php echo e(count($unidades)); ?></div>
                        <div class="stat-desc">Unidades registradas</div>
                        <a href="<?php echo e(url('unidades')); ?>" class="btn btn-details">
                            Ver registros
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="count-number"><?php echo e(count($archivos)); ?></div>
                        <div class="stat-desc">Documentos del sistema</div>
                        <a href="<?php echo e(url('archivos')); ?>" class="btn btn-details">
                            Ver registros
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="count-number"><?php echo e(count($categorias)); ?></div>
                        <div class="stat-desc">Clasificaciones</div>
                        <a href="<?php echo e(url('categorias')); ?>" class="btn btn-details">
                             Ver registros
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="count-number"><?php echo e(count($usuarios)); ?></div>
                        <div class="stat-desc">Usuarios activos</div>
                        <a href="<?php echo e(url('usuarios')); ?>" class="btn btn-details">
                          Ver registros
                        </a>
                    </div>
                </div>
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'smaf')): ?>
    <div class="mb-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="count-number"><?php echo e(count($financierasSmaf ?? [])); ?></div>
                        <div class="stat-desc">Documentos en SMAF</div>
                        <a href="<?php echo e(url('smaf/financieras')); ?>" class="btn btn-details">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="count-number">
                            <?php echo e(collect($financierasSmaf ?? [])->where('estado_administrativo', 'pendiente')->count()); ?>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="count-number">
                            <?php echo e(collect($financierasSmaf ?? [])->where('enviado_a_despacho', true)->count()); ?>

                        </div>
                        <div class="stat-desc">Enviados a Despacho</div>
                        <a href="<?php echo e(url('areas')); ?>" class="btn btn-details">
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'despacho')): ?>
    <div class="mb-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="stat-label">Registros</div>
                        <div class="count-number"><?php echo e(count($financierasDespacho ?? [])); ?></div>
                        <div class="stat-desc">Total asignados</div>
                        <a href="<?php echo e(url('despacho/financieras')); ?>" class="btn btn-details">
                            <i class="bi bi-gear me-1"></i> Gestionar
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="count-number">
                            <?php echo e(collect($financierasDespacho ?? [])->where('estado_administrativo', 'pendiente')->count()); ?>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="count-number">
                            <?php echo e(collect($financierasDespacho ?? [])->where('enviado_a_tesoreria', true)->count()); ?>

                        </div>
                        <div class="stat-desc">A Tesorería</div>
                        <a href="<?php echo e(url('areas-despacho')); ?>" class="btn btn-details">
                            <i class="bi bi-file-text me-1"></i> Actas
                        </a>
                    </div>
                </div>
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'tesoreria')): ?>
    <div class="mb-4">
        <h3 class="section-title">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="stat-label">Registros</div>
                        <div class="count-number"><?php echo e(count($financierasTesoreria ?? [])); ?></div>
                        <div class="stat-desc">Total recibidos</div>
                        <a href="<?php echo e(url('tesoreria/financieras')); ?>" class="btn btn-details">
                            <i class="bi bi-gear me-1"></i> Gestionar
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="count-number"><?php echo e(count($financierasArchivos ?? [])); ?></div>
                        <div class="stat-desc">Documentos guardados</div>
                        <a href="<?php echo e(url('areas-archivos')); ?>" class="btn btn-details">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="count-number">
                            <?php echo e(collect($financierasTesoreria ?? [])->where('estado_tesoreria', 'recibido')->count()); ?>
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'archivos')): ?>
    <div class="mb-4">
        <h3 class="section-title">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="count-number"><?php echo e(count($historialArchivos)); ?></div>
                        <div class="stat-desc">Movimientos</div>
                        <a href="<?php echo e(url('historial-archivos')); ?>" class="btn btn-details">
                            <i class="bi bi-eye me-1"></i> Ver
                        </a>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="<?php echo e(url('ubicaciones')); ?>" class="btn btn-details">
                            <i class="bi bi-eye me-1"></i> Ver
                        </a>
                    </div>
                </div>
    ...
    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'central')): ?>
    <div class="mb-4">
        <h3 class="section-title">
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Cantidad',
                    data: [
                        <?php echo e(count($unidades)); ?>,
                        <?php echo e(count($archivos)); ?>,
                        <?php echo e(count($categorias)); ?>,
                        <?php echo e(count($financierasSmaf ?? [])); ?>,
                        <?php echo e(count($financierasDespacho ?? [])); ?>,
                        <?php echo e(count($financierasTesoreria ?? [])); ?>,
                        <?php echo e(count($financierasArchivos ?? [])); ?>,
            
                        <?php echo e(count($usuarios)); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\sisarchivo\resources\views/index.blade.php ENDPATH**/ ?>